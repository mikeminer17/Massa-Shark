...
echo
echo "\e[42mПочаток bootstraping\e[0m\n"
echo '[bootstrap]
max_ping = 10000
bootstrap_list = [
...
echo "Закінчено \e[32bootstraping\e[39m, перевірте логи:"
echo "\e[32mmassa_log\e[39m або \e[32mjournalctl -n 100 -f -u massad\e[39m"